  ...
  public static CreateScene(engine: BABYLON.Engine, canvas: HTMLCanvasElement): BABYLON.Scene {
    ...
    const loadAssets = async (scene: BABYLON.Scene): Promise<void> => {
      ...
      const ybotTopAnimatedAsset = new AnimatedAsset(ybotTopURL, new BABYLON.Vector3(),
        new BABYLON.Vector3(), new BABYLON.Vector3(1, 1, 1).scale(0.011),
      ...
      ybotTop.setParent(compoundBody, new BABYLON.Vector3(),
        new BABYLON.Vector3(0, Math.PI / 2, 0));
      ...
      for (let i = 0; i < 30; i++) {
        ...
        ybotTop.setParent(compoundBody2, new BABYLON.Vector3(),
          new BABYLON.Vector3(0, Math.PI / 2, 0));

        const ybotBottom = new AnimatedAssetClone(ybotBottomAnimatedAsset, scene);
        ybotBottom.setParent(compoundBody2, new BABYLON.Vector3(0, -1, 0),
          new BABYLON.Vector3(0, Math.PI / 2, 0));
