...
(function (CollisionFilterGroup) {
    CollisionFilterGroup[CollisionFilterGroup["Ground"] = 4] = "Ground";
    CollisionFilterGroup[CollisionFilterGroup["Rock"] = 8] = "Rock";
})(CollisionFilterGroup || (CollisionFilterGroup = {}));
var CollisionFilterMask;
(function (CollisionFilterMask) {
    CollisionFilterMask[CollisionFilterMask["Ground"] = 8] = "Ground";
    CollisionFilterMask[CollisionFilterMask["Rock"] = 4] = "Rock";
})(CollisionFilterMask || (CollisionFilterMask = {}));
const createEngine = function () {
    return new BABYLON.Engine(document.getElementById('renderCanvas'));
};
async function initPhysics(scene) {
    ...
    rock.physicsImpostor = new BABYLON.PhysicsImpostor(rock, BABYLON.PhysicsImpostor.BoxImpostor, {
        mass: 1,
        friction: 1,
        restitution: 0.5,
        // @ts-ignore
