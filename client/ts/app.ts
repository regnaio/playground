...
class Playground {
  public static CreateScene(engine: BABYLON.Engine, canvas: HTMLCanvasElement): BABYLON.Scene {
    ...
    const loadAssets = async (scene: BABYLON.Scene): Promise<void> => {
      ...
      const knifeAsset = new Asset(knifeURL,
        new BABYLON.Vector3(),
        new BABYLON.Vector3(),
      ...
      const ybotTopAnimatedAsset = new AnimatedAsset(ybotTopURL, new BABYLON.Vector3(),
        new BABYLON.Vector3(0, 0, 0), new BABYLON.Vector3(0.011, 0.011, 0.011),
      ...
      await Promise.all([ak47Asset.promise, pistolAsset.promise, knifeAsset.promise, ybotTopAnimatedAsset.promise, ybotBottomAnimatedAsset.promise]);
